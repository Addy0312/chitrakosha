        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <a href="#" className="text-foreground hover:text-primary transition-colors">Sell Art</a>
              <a href="#" className="text-foreground hover:text-primary transition-colors">Commission</a>
      ...
      <footer className="bg-card border-t border-border py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">Commission Work</a></li>
                <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">Artist Resources</a></li>
          ...
          <div className="border-t border-border pt-8 text-center">
            <p className="text-muted-foreground">
              © 2024 Chitrakosha. All rights reserved. Made with ❤️ in India.
            </p>
          </div>
        </div>
      </footer>
